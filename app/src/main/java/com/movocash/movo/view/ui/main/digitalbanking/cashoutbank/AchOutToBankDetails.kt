...
import com.movocash.movo.databinding.FragmentAchOutToBankDetailsBinding
import com.movocash.movo.utilities.Constants
import com.movocash.movo.viewmodel.CommonViewModel
import java.lang.reflect.Type

class AchOutToBankDetails : BaseFragment(), View.OnClickListener, IInfoListener {

    lateinit var binding: FragmentAchOutToBankDetailsBinding
    ...
    companion object {
        lateinit var instance: AchOutToBankDetails
        lateinit var model: CustomCashOutBankModel

        fun newInstance(obj: CustomCashOutBankModel): AchOutToBankDetails {
            instance = AchOutToBankDetails()
            model = obj
            return instance
        }
    }
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_ach_out_to_bank_details, container, false)
        ...
        bankViewModel.cashToBankTransferResponseModel.observe(viewLifecycleOwner, Observer {
            it?.let { obj ->
                if (obj != null && obj.data != null && obj.data!!.responseDesc != null && !TextUtils.isEmpty(obj.data!!.responseDesc)) {
                    ...
                    addFragment(R.id.mainContainer, AchOutReciept.newInstance(model), "CashOutBankDetailFragment")
                }
            }
        })
    }
