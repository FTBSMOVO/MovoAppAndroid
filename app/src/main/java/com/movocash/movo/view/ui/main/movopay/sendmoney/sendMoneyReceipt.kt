...
import com.movocash.movo.databinding.FragmentSendMoneyReceiptBinding
...
class sendMoneyReceipt : BaseFragment(), View.OnClickListener, IInfoListener {

    lateinit var binding: FragmentSendMoneyReceiptBinding
    private lateinit var cardsViewModel: CardViewModel
    private lateinit var commonViewModel: CommonViewModel

    companion object {
        lateinit var instance: sendMoneyReceipt
        lateinit var cardNum: String
        lateinit var requestModel: ShareFundRequestModel
        private var primaryAmount = 0.0

        fun newInstance(cardNumber: String, obj: ShareFundRequestModel, balance: Double): sendMoneyReceipt {
            instance = sendMoneyReceipt()
            cardNum = cardNumber
            requestModel = obj
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_send_money_receipt, container, false)
    ...
    private fun setUiObserver() {
        ...
        cardsViewModel.shareFundResponseModel.observe(viewLifecycleOwner, Observer { obj ->
            if (!TextUtils.isEmpty(obj.data!!.responseDesc!!)) {
                ...
                callFragmentWithReplace(R.id.mainContainer, sendMoneyReceipt(), null)
    ...
    override fun onClick(v: View?) {
        when (v!!.id) {
            ...
            R.id.btnAnotherTransfer -> {
                ...
                callFragment(R.id.mainContainer, SendMoneyFragment(), null)
            }
        }
    }
