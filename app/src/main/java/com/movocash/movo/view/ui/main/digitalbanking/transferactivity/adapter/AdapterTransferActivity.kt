package com.movocash.movo.view.ui.main.digitalbanking.transferactivity.adapter
...
import com.movocash.movo.databinding.AdapterTransferActivityBinding
import com.movocash.movo.utilities.Constants
import com.movocash.movo.utilities.utils.DateUtil

class AdapterTransferActivity(private val mList: ArrayList<MyCustomScheduleTransferModels>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {

    lateinit var itemBinding: AdapterTransferActivityBinding
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        return when (viewType) {
            0 -> {
                itemBinding = DataBindingUtil.inflate(layoutInflater, R.layout.adapter_transfer_activity, parent, false)
    ...
    class ItemViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        var binding: AdapterTransferActivityBinding = DataBindingUtil.bind(view)!!
    }
