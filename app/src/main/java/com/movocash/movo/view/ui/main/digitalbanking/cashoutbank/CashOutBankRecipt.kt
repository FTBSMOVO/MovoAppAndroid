...
class CashOutBankRecipt : BaseFragment(), View.OnClickListener, IInfoListener {

    lateinit var binding: FragmentCashOutBankReciptBinding
    ...
    companion object {
        lateinit var instance: CashOutBankRecipt
        lateinit var model: CustomCashOutBankModel

        fun newInstance(obj: CustomCashOutBankModel): CashOutBankRecipt {
            instance = CashOutBankRecipt()
            model = obj
            return instance
        }
    }
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_cash_out_bank_recipt, container, false)
    ...
    override fun onClick(v: View?) {
        when (v!!.id) {
            ...
            R.id.btnAnotherTransfer -> {
                ...
                callFragment(R.id.mainContainer, CashOutBankFragment(), null)
            }
        }
    }
